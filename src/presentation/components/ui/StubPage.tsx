...
export function StubPage({ title, subtitle }: StubPageProps) {
  return (
    <main className="flex min-h-[60vh] flex-col items-center justify-center gap-8 px-5 py-[60px] lg:px-[120px] lg:py-[120px]">
      <span className="font-inter text-[11px] font-medium tracking-[3px] text-gold">
        COMING SOON
      </span>
      <h1 className="text-center font-cormorant text-4xl font-light tracking-[-1px] text-text-primary lg:text-6xl">
        {title}
      </h1>
